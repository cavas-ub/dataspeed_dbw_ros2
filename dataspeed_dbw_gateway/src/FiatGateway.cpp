...
class FiatGateway : public rclcpp::Node {
 public:
  FiatGateway(const rclcpp::NodeOptions &options) : rclcpp::Node("gateway", options) {
...
RCLCPP_COMPONENTS_REGISTER_NODE(dataspeed_dbw_gateway::FiatGateway)
